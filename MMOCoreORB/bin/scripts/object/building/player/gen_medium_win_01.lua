...
object_building_player_generic_medium_window_s01 = object_building_player_shared_generic_medium_window_s01:new {
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/player/house_address.iff", x = 5.13, z = 2.25, y = 7.91, ox = 0, oy = 1, oz = 0, ow = 01, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
