...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s02_bracer_r, "object/tangible/wearables/armor/marauder/armor_marauder_s02_bracer_r.iff")
