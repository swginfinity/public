...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s01_chest_plate, "object/tangible/wearables/armor/marauder/armor_marauder_s01_chest.iff")
