...
ObjectTemplates:addTemplate(object_draft_schematic_armor_armor_marauder_s02_helmet, "object/tangible/wearables/armor/marauder/armor_marauder_s02_helmet.iff")
