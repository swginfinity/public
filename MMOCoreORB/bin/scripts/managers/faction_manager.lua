...
factionList = {
	...
	{ "black_krrsantans", true, "lost_aqualish,drall,xonti_brothers", "corsec,kobola,alkhara", 1.0 },
	{ "xonti_brothers", true, "black_krrsantans,kobola", "alkhara,hidden_daggers", 1.0 }
