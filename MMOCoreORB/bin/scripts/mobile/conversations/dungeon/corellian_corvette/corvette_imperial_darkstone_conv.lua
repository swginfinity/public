...
already_busy = ConvoScreen:new {
	...
	options = {
		{"I would rather work for you.","change_quest"}
	}
}
corvetteDarkstoneConvoTemplate:addScreen(already_busy);

change_quest = ConvoScreen:new {
	id = "change_quest",
	customDialogText = "Excellent, I will make that change now!",
	stopConversation = "true",
	options = {	}
}
corvetteDarkstoneConvoTemplate:addScreen(change_quest);
