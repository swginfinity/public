...
-- MGMT commands
reset_now = ConvoScreen:new {
	id = "reset_now",
	leftDialog = "", 
	customDialogText = "Election reset immediately.",
	stopConversation = "true",
	options = {}
}
tourAryonConvoTemplate:addScreen(reset_now);

reset_def = ConvoScreen:new {
	id = "reset_def",
	leftDialog = "", 
	customDialogText = "Election reset to default time.",
	stopConversation = "true",
	options = {}
}
tourAryonConvoTemplate:addScreen(reset_def);

reset_no = ConvoScreen:new {
	id = "reset_no",
	leftDialog = "", 
	customDialogText = "Election left alone",
	stopConversation = "true",
	options = {}
}
tourAryonConvoTemplate:addScreen(reset_no);
