...
function RoriImperialEncampmentScreenPlay:spawnRebels()
	...
	spawnMobile("rori", "rebel_surface_marshal", 300, 1.4, 1.0, 9.9, -90, 2935406)
	spawnMobile("rori", "rebel_surface_marshal", 300, 6.4, 1.0, -7.2, -90, 2935406)
	spawnMobile("rori", "rebel_surface_marshal", 300, 0.0, 1.0, 0.9, 0, 2935406)

	spawnMobile("rori", "rebel_first_lieutenant", 300, 15.7, 1.0, 15.2, 90, 2935407)
	spawnMobile("rori", "rebel_surface_marshal", 300, -17.7, 1.0, 16.5, 180, 2935408)
