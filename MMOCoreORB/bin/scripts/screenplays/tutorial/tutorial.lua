...
function TutorialScreenPlay:start(pPlayer)
	...
	local pGhost = CreatureObject(pPlayer)
	...
	if (playerProfession ~= "") then
		print("starter profession: " .. playerProfession .. "_novice")
		local starterProf = 0
		if playerProfession .. "_novice" == "combat_brawler_novice" then
			starterProf = 1
		elseif playerProfession .. "_novice" == "combat_marksman_novice" then
			starterProf = 2
		elseif playerProfession .. "_novice" == "outdoors_scout_novice" then
			starterProf = 4
		elseif playerProfession .. "_novice" == "science_medic_novice" then
			starterProf = 8
		elseif playerProfession .. "_novice" == "social_entertainer_novice" then
			starterProf = 16
		elseif playerProfession .. "_novice" == "crafting_artisan_novice" then
			starterProf = 32
		end
		print("startprof: " .. starterProf)
		pGhost:setScreenPlayState(starterProf, "tutorialprofession")
