...
function  mission_direction_choice:dirSelection(pPlayer, pSui, eventIndex, args)
	...
	if (selectedDir == 0) then
		...
		CreatureObject(pPlayer):sendSystemMessage("You have selected to take missions in the " .. selectedDirDesc .. " direction. This choice will remain active until you choose to change or reset it.")
	end
